...
const Handelingen: React.FC = () => {
    const [currentHandelingIndex, setCurrentHandelingIndex] =
        useState<number>(0);
        ...
        <div className="flex flex-col mt-20 mb-36 h-screen">
            ...
            <div className="w-96 mx-auto pb-5">
                <div className="py-10">
                    ...
                    <p className="pt-4">
                        Een hartaanval kan overal plaatsvinden. Thuis, tijdens
                        werk of tijdens sporten. Om een effectieve eerste hulp
                        te bieden, worden er stappen gevolgd. Hier krijg je
                        stap-voor-stap uitleg over eerste hulp bij
                        hartaanvallen.
                    </p>
                </div>
                <div className="pt-5">
                ...
                <div className="pt-5">
                    ...
                    >
                        (Afbeelding afkomstig van: Wikihow - CPR toepassen)
                    </a>
                </div>
            </div>
            {!hasNext ? ( // Use the variable hasNext
                <div className="container w-96 mx-auto flex flex-col items-center pb-4 z-10">
                    ...
                    <a
                        href="/"
                        className="btn btn-lg btn-secondary btn-block my-3 mb-16 text-center"
                    >
